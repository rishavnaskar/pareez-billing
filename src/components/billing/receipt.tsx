  ...
  return (
    <div className="mt-8 text-center text-xs text-gray-500 dark:text-gray-400">
      ...
      <div className="mt-4 space-y-2">
        <p className="font-semibold text-gray-700 dark:text-gray-200">Follow & Review Us:</p>
        <div className="space-y-1">
          <p>
            <span className="text-blue-600 dark:text-blue-400">⭐ Google Review:</span>
            <a
          ...
          <p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-pink-600 dark:text-pink-400 underline hover:text-pink-800 dark:hover:text-pink-300 break-all"
            >
              {SOCIAL_LINKS.instagram.label}
            </a>
          </p>
          <p>
            <span className="text-blue-700 dark:text-blue-400">📘 Facebook:</span>
            <a
              href={SOCIAL_LINKS.facebook.url}
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-700 dark:text-blue-400 underline hover:text-blue-900 dark:hover:text-blue-300 break-all"
            >
